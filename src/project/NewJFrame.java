...
public class NewJFrame extends javax.swing.JFrame {
  ...
  public void CenteredF(javax.swing.JFrame objFrame){
        Dimension objDimension = Toolkit.getDefaultToolkit().getScreenSize();
        int iCoordX = (objDimension.width - objFrame.getWidth()) / 2;
        int iCoordY = (objDimension.height - objFrame.getHeight()) / 2;
        objFrame.setLocation(iCoordX, iCoordY);
        objFrame.setTitle("Inventory Management System");
    } 
    ...
    private void initComponents() {
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/copy.jpg"))); // NOI18N
...
int mo = Integer.parseInt(mk);
  ...
  try{
     ...
     Connection con = (Connection)DriverManager.getConnection("jdbc:mysql://localhost/pro","root","");
      ...
      for(int lu  = 0 ; lu <= ll ; ++lu)
{
  model.removeRow(0);
   ...
   while(rs.next())
     {
        model.addRow (new Object[] {rs.getString("Supplier_code"),rs.getString("Supplier_name"),rs.getString("address"),rs.getString("city"),rs.getString("pin_no"),rs.getString("phone_no")});
   }
